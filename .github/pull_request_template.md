...
- [ ] All existing unit tests pass (`./test`)
- [ ] All linting checks pass (`./lint`)
...
- [ ] Code comments/docstrings added/updated
...
- [ ] PR title is clear and follows conventional commit format
- [ ] CHANGELOG.md will be updated before merge
